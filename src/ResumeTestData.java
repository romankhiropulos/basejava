...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.getSectionType().put(PERSONAL, new TextSection("Аналитический склад ума, сильная логика, " +
                "креативность, инициативность. Пурист кода и архитектуры."));
        resume.getSectionType().put(OBJECTIVE, new TextSection("Ведущий стажировок и корпоративного обучения по Java " +
                "Web и Enterprise технологиям."));
        resume.getSectionType().put(ACHIEVEMENT, new ProgressSection(Arrays.asList("С 2013 года: разработка проектов " +
        ...
        resume.getSectionType().put(QUALIFICATIONS, new ProgressSection(Arrays.asList("JEE AS: GlassFish (v2.1, v3), " +
                        ...
                        "Security, Data, Clouds, Boot), JPA (Hibernate, EclipseLink), Guice, " +
                ...
                "Python: Django.\n" +
                        ...
                        "XSLT, MDB, JMX, JDBC, JPA, JNDI, JAAS, SOAP, AJAX, Commet, HTML5, ESB, CMIS, BPMN2, LDAP, " +
                        "OAuth1, OAuth2, JWT.",
