...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ...
        resume.getSectionType().put(ACHIEVEMENT, new ProgressSection(Arrays.asList("С 2013 года: разработка проектов \"Разработка Web приложения\",\"Java Enterprise\", \"Многомодульный maven. Многопоточность. XML (JAXB/StAX). Веб сервисы (JAX-RS/SOAP). Удаленное взаимодействие (JMS/AKKA)\". Организация онлайн стажировок и ведение проектов. Более 1000 выпускников.",
        ...
        resume.getSectionType().put(QUALIFICATIONS, new ProgressSection(Arrays.asList("JEE AS: GlassFish (v2.1, v3), OC4J, JBoss, Tomcat, Jetty, WebLogic, WSO2\n" +
        ...
        resume.getSectionType().put(EXPERIENCE, new LocationSection(Arrays.asList(new Location("Wrike", "wrike.com", Arrays.asList(new Position(DateUtil.of(2003, FEBRUARY), DateUtil.of(2005, FEBRUARY), "Engineer", "Making code"))))));
        resume.getSectionType().put(EDUCATION, new LocationSection(Arrays.asList(new Location("ITMO", "itmo.com", Arrays.asList(new Position(DateUtil.of(1987, FEBRUARY), DateUtil.of(1989, FEBRUARY), "Student", ""),
